...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1cd2e644e2b28023873fee45b6418db3,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'id-ID', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Maru', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Nulis dimana aja, kapan aja', // 作者简介 , 一个普通的干饭人🍚
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://maru.my', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Notion, Fediverse, SEO, Digital Marketing', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Brain search for Novelty karena banyak dopamin',
